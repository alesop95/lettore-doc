...
Sorgente nuova disponibile dal 2026-09-14, mai ingerita: `LETTERDOC_SOURCE_PORTFOLIO`, riparato e ripuntato su Proton (dettaglio nel work-log). Copre `IT-RELATED`, `Progetti (consulenza)`, `Progetti (idee)` e da oggi `🛠️ Ongoing studies`, 1004 file in cinque aree (Cybersec/BC/governance, Generative AI, Quantitative Finance, Full-stack development, qbit computing). Nessun ciclo mai aperto su questo lato: il passo 0, selezione a mano di una prima sottocartella coesa, e' tutto da fare.
